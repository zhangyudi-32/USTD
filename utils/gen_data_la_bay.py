...
def generate_train_val_test(args):
    ...
    df = load_air(args.traffic_df_filename)
    df = df.transpose(1, 0)
...
def load_air(data_path, pred_attrs='PM25'):
    ...
    for id, station_aq in raw_data.groupby('station_id'):
        ...
        data['pred'].append(station_aq[pred_attrs].to_numpy()[np.newaxis])
        data['missing'].append(missing.loc[missing['station_id'] == id][pred_attrs + '_Missing'].to_numpy()[np.newaxis])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="../dataset/airquality/guangzhou2", help="Output directory.")
    parser.add_argument("--traffic_df_filename", type=str, default="../dataset/airquality/guangzhou/guangzhou.h5", help="Raw traffic readings.",)
